...
class Shapes {
	static public function main() {
		var root = new Sprite();
		ScriptContext.container.addChild(root);
	...
	private static function drawPolygon(graphics:Graphics, x:Float, y:Float, radius:Float, sides:Int):Void {
